mod slint_generatedAppWindow {
     ...
     ;
     # [derive (Default , PartialEq , Debug , Clone)] pub struct r#DiskItem {
         pub r#label : sp :: SharedString , pub r#path : sp :: SharedString , pub r#selected : bool , pub r#size : sp :: SharedString }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] pub struct InnerDiskRow_root_5 {
         r#root_5 : sp :: r#BasicBorderRectangle , r#empty_7 : sp :: r#Empty , r#text_8 : sp :: r#SimpleText , r#text_9 : sp :: r#SimpleText , r#rectangle_10 : sp :: r#Empty , r#text_11 : sp :: r#SimpleText , r#toucharea_12 : sp :: r#TouchArea , r#root_5_empty_6_layout_cache : sp :: Property < sp :: SharedVector < sp :: Coord , > > , r#root_5_empty_6_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#root_5_empty_6_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , r#root_5_empty_7_layout_cache : sp :: Property < sp :: SharedVector < sp :: Coord , > > , r#root_5_empty_7_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#root_5_empty_7_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , r#root_5_height : sp :: Property < sp :: LogicalLength > , r#root_5_label : sp :: Property < sp :: SharedString > , r#root_5_path : sp :: Property < sp :: SharedString > , r#root_5_selected : sp :: Property < bool > , r#root_5_size : sp :: Property < sp :: SharedString > , r#root_5_width : sp :: Property < sp :: LogicalLength > , r#root_5_y : sp :: Property < sp :: LogicalLength > , r#root_5_activated : sp :: Callback < () , () > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerDiskRow_root_5 >> , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerDiskRow_root_5 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5 }
                 + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (slint :: Brush :: SolidColor (if ({
                         * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_selected }
                    ) . apply_pin (_self) . get () {
                         (sp :: Color :: from_argb_encoded ((4292732671f64) as u32)) as _ }
                     else {
                         sp :: Color :: from_argb_encoded ((4294967295f64) as u32) }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             ...
                             the_struct . r#constraint = ({
                                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_7_layoutinfo_h }
                            ) . apply_pin (_self) . get () as _ ;
                             the_struct }
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = {
                                 let r#layout_info = sp :: Item :: layout_info (({
                                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#rectangle_10 }
                         ...
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_11 }
                             ...
                             the_struct }
                         as _ , r#size : ({
                             * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_width }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layoutinfo_h }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#box_layout_info (sp :: Slice :: from_slice (& [{
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layoutinfo_v }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#box_layout_info_ortho (sp :: Slice :: from_slice (& [{
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                         the_struct . r#constraint = ({
                             * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_7_layoutinfo_v }
                        ) . apply_pin (_self) . get () as _ ;
                         the_struct }
                     , {
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_7_layout_cache }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_8 }
                         ...
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_9 }
                            ) . apply_pin (_self) , sp :: Orientation :: Vertical , & _self . globals . get () . unwrap () . window_adapter_impl () , & & sp :: ItemRc :: new (sp :: VRcMapped :: origin (& _self . self_weak . get () . unwrap () . upgrade () . unwrap ()) , _self . tree_index_of_first_child . get () + 6u32 - 1)) as _ ;
                             the_struct }
                        ]) as _ , r#padding : {
                             let mut the_struct = sp :: Padding :: default () ;
                             the_struct . r#begin = 12f64 as _ ;
                             ...
                             the_struct }
                         as _ , r#size : (((((({
                             * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_height }
                        ) . apply_pin (_self) . get () . get ()) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as _ , r#spacing : 4f64 as _ , }
                     as _ , sp :: Slice :: from_slice (& []) as _)) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_7_layoutinfo_h }
                     ...
                     , {
                         ...
                         the_struct . r#constraint = sp :: Item :: layout_info (({
                             * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_9 }
                        ) . apply_pin (_self) , sp :: Orientation :: Horizontal , & _self . globals . get () . unwrap () . window_adapter_impl () , & & sp :: ItemRc :: new (sp :: VRcMapped :: origin (& _self . self_weak . get () . unwrap () . upgrade () . unwrap ()) , _self . tree_index_of_first_child . get () + 6u32 - 1)) as _ ;
                         the_struct }
                    ]) as _ , & {
                         let mut the_struct = sp :: Padding :: default () ;
                         the_struct . r#begin = 12f64 as _ ;
                 ...
                 }
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#text) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (({
                         * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_label }
                    ) . apply_pin (_self) . get ()) as _ }
                ) ;
                 }
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#width) . apply_pin (_self) , & self_rc , move | self_rc | {
                     ...
                     (sp :: LogicalLength :: new ((((((({
                         * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                    ) . apply_pin (_self) . get () [1usize]) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             ({
                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_9 }
                 ...
                 }
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#text) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (({
                         * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_path }
                    ) . apply_pin (_self) . get ()) as _ }
                ) ;
                 }
             {
             ...
             ({
                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_11 }
             + sp :: r#SimpleText :: FIELD_OFFSETS . r#color) . apply_pin (_self) . set ({
                 (slint :: Brush :: SolidColor (sp :: Color :: from_argb_encoded ((4281550956f64) as u32))) as slint :: Brush }
            ) ;
             ({
                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#text_11 }
             + sp :: r#SimpleText :: FIELD_OFFSETS . r#font_size) . apply_pin (_self) . set ({
            ...
            ) ;
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#text) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (({
                         * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_size }
                    ) . apply_pin (_self) . get ()) as _ }
                ) ;
                 }
             ({
                 ...
                 }
             {
                 # [allow (unreachable_code , unused)] slint :: private_unstable_api :: set_callback_handler (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#toucharea_12 }
                 + sp :: r#TouchArea :: FIELD_OFFSETS . r#clicked) . apply_pin (_self) , & self_rc , {
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         (({
                             * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_activated }
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             ...
             let (h , w , x , y) = match index {
                 0u32 => (({
                     ...
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_y }
                ) . apply_pin (_self) . get () . get () as sp :: Coord ,) , 1u32 => ((((((({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_height }
                ) . apply_pin (_self) . get () . get ()) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [1usize] as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [0usize] as sp :: Coord , 12f64 as sp :: Coord ,) , 2u32 => ((((((({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_height }
                ) . apply_pin (_self) . get () . get ()) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as sp :: Coord , 0f64 as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [2usize] as sp :: Coord , 12f64 as sp :: Coord ,) , 3u32 => ((((((({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_height }
                ) . apply_pin (_self) . get () . get ()) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [5usize] as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [4usize] as sp :: Coord , 12f64 as sp :: Coord ,) , 4u32 => (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_height }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_width }
                     ...
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [1usize]) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as sp :: Coord , 12f64 as sp :: Coord , ({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_7_layout_cache }
                ) . apply_pin (_self) . get () [0usize] as sp :: Coord ,) , 6u32 => (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_7_layout_cache }
                ) . apply_pin (_self) . get () [3usize] as sp :: Coord , (((((({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layout_cache }
                ) . apply_pin (_self) . get () [1usize]) as f64) - ((12f64) as f64)) as f64) - ((12f64) as f64)) as sp :: Coord , 12f64 as sp :: Coord , ({
         ...
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             # ! [allow (unused)] let _self = self ;
             match index {
                 3u32 => sp :: r#AccessibleRole :: r#Text , 5u32 => sp :: r#AccessibleRole :: r#Text , 6u32 => sp :: r#AccessibleRole :: r#Text , _ => sp :: AccessibleRole :: default () , }
             }
         fn accessible_string_property (self : :: core :: pin :: Pin < & Self > , index : u32 , what : sp :: AccessibleStringProperty ,) -> sp :: Option < sp :: SharedString > {
             # ! [allow (unused)] let _self = self ;
             match (index , what) {
                 (3u32 , sp :: AccessibleStringProperty :: r#Label) => sp :: Some (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_size }
                ) . apply_pin (_self) . get ()) , (5u32 , sp :: AccessibleStringProperty :: r#Label) => sp :: Some (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_label }
                ) . apply_pin (_self) . get ()) , (6u32 , sp :: AccessibleStringProperty :: r#Label) => sp :: Some (({
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_path }
                ) . apply_pin (_self) . get ()) , _ => sp :: None , }
             }
         fn accessibility_action (self : :: core :: pin :: Pin < & Self > , index : u32 , action : & sp :: AccessibilityAction) {
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] pub struct InnerDiskContent_root_13 {
         r#root_13 : sp :: r#Empty , r#text_14 : sp :: r#SimpleText , r#_visibility_15 : sp :: r#Clip , r#text_16 : sp :: r#SimpleText , r#_visibility_17 : sp :: r#Clip , r#empty_18 : sp :: r#Empty , r#flickable_19 : sp :: r#Flickable , r#flickable_viewport_20 : sp :: r#Empty , r#vertical_bar_visibility_23 : sp :: r#Clip , r#vertical_bar_24 : sp :: r#Rectangle , r#vertical_bar_clip_25 : sp :: r#Clip , r#border_26 : sp :: r#Rectangle , r#thumb_opacity_27 : sp :: r#Opacity , r#thumb_28 : sp :: r#BasicBorderRectangle , r#touch_area_29 : sp :: r#TouchArea , r#horizontal_bar_visibility_30 : sp :: r#Clip , r#horizontal_bar_31 : sp :: r#Rectangle , r#horizontal_bar_clip_32 : sp :: r#Clip , r#border_33 : sp :: r#Rectangle , r#thumb_opacity_34 : sp :: r#Opacity , r#thumb_35 : sp :: r#BasicBorderRectangle , r#touch_area_36 : sp :: r#TouchArea , r#root_13_empty_18_horizontal_scrollbar_policy : sp :: Property < sp :: r#ScrollBarPolicy > , r#root_13_empty_18_vertical_scrollbar_policy : sp :: Property < sp :: r#ScrollBarPolicy > , r#root_13_empty_18_visible_height : sp :: Property < sp :: LogicalLength > , r#root_13_empty_18_visible_width : sp :: Property < sp :: LogicalLength > , r#root_13_flickable_viewport_20_y : sp :: Property < sp :: LogicalLength > , r#root_13_height : sp :: Property < sp :: LogicalLength > , r#root_13_horizontal_bar_31_height : sp :: Property < sp :: LogicalLength > , r#root_13_horizontal_bar_31_maximum : sp :: Property < sp :: LogicalLength > , r#root_13_horizontal_bar_31_pad : sp :: Property < sp :: LogicalLength > , r#root_13_horizontal_bar_31_visible : sp :: Property < bool > , r#root_13_horizontal_bar_31_width : sp :: Property < sp :: LogicalLength > , r#root_13_horizontal_bar_31_y : sp :: Property < sp :: LogicalLength > , r#root_13_items : sp :: Property < sp :: ModelRc < r#DiskItem > > , r#root_13_layout_cache : sp :: Property < sp :: SharedVector < sp :: Coord , > > , r#root_13_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#root_13_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , r#root_13_thumb_28_height : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_28_width : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_28_x : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_28_y : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_35_height : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_35_width : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_35_x : sp :: Property < sp :: LogicalLength > , r#root_13_thumb_35_y : sp :: Property < sp :: LogicalLength > , r#root_13_touch_area_29_pressed_value : sp :: Property < sp :: LogicalLength > , r#root_13_touch_area_36_pressed_value : sp :: Property < sp :: LogicalLength > , r#root_13_vertical_bar_24_height : sp :: Property < sp :: LogicalLength > , r#root_13_vertical_bar_24_maximum : sp :: Property < sp :: LogicalLength > , r#root_13_vertical_bar_24_pad : sp :: Property < sp :: LogicalLength > , r#root_13_vertical_bar_24_visible : sp :: Property < bool > , r#root_13_vertical_bar_24_width : sp :: Property < sp :: LogicalLength > , r#root_13_vertical_bar_24_x : sp :: Property < sp :: LogicalLength > , r#root_13_width : sp :: Property < sp :: LogicalLength > , r#root_13_disk_selected : sp :: Callback < (i32 ,) , () > , r#root_13_horizontal_bar_31_scrolled : sp :: Callback < () , () > , r#root_13_vertical_bar_24_scrolled : sp :: Callback < () , () > , repeater0 : sp :: Repeater < InnerComponent_diskrow_21 > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerDiskContent_root_13 >> , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerDiskContent_root_13 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_horizontal_scrollbar_policy }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_vertical_scrollbar_policy }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#ScrollBarPolicy :: r#AsNeeded) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layout_cache }
                    ) . apply_pin (_self) . get () [5usize]) as f64) - ((4f64) as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_width }
                    ) . apply_pin (_self) . get () . get ()) as f64) - ((16f64) as f64)) as f64) - ((16f64) as f64)) as f64) - ((4f64) as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#touch_area_36 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_maximum }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#flickable_19 }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_pad }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
             ...
             {
                 # [allow (unreachable_code , unused)] slint :: private_unstable_api :: set_callback_handler (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_scrolled }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_visible }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ({
                         let r#tmp_root_13_empty_18_horizontal_scrollbar_policy = ({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_horizontal_scrollbar_policy }
                        ) . apply_pin (_self) . get () ;
                         ((((r#tmp_root_13_empty_18_horizontal_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AlwaysOn)))) || ((((((r#tmp_root_13_empty_18_horizontal_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AsNeeded)))) && ((((({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_maximum }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_visible }
                    ) . apply_pin (_self) . get () {
                         ((((((((({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_width }
                        ) . apply_pin (_self) . get () . get ()) as f64) - ((16f64) as f64)) as f64) - ((16f64) as f64)) as f64) - ((({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_width }
                        ) . apply_pin (_self) . get () . get ()) as f64))) as _ }
                     else {
                         ((((({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_width }
                        ) . apply_pin (_self) . get () . get ()) as f64) - ((16f64) as f64)) as f64) - ((16f64) as f64) }
                     as sp :: Coord)) as _ }
                 , {
                     let mut the_struct = sp :: PropertyAnimation :: default () ;
                     the_struct . r#delay = 0f64 as _ ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layout_cache }
                     ...
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layout_cache }
                     ...
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#text_14 }
                            ) . apply_pin (_self) , sp :: Orientation :: Vertical , & _self . globals . get () . unwrap () . window_adapter_impl () , & & sp :: ItemRc :: new (sp :: VRcMapped :: origin (& _self . self_weak . get () . unwrap () . upgrade () . unwrap ()) , _self . tree_index_of_first_child . get () + 1u32 - 1)) as _ ;
                             the_struct }
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#text_16 }
                         ...
                         , {
                             ...
                             the_struct . r#constraint = {
                                 let r#layout_info = sp :: Item :: layout_info (({
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#empty_18 }
                                ) . apply_pin (_self) , sp :: Orientation :: Vertical , & _self . globals . get () . unwrap () . window_adapter_impl () , & & sp :: ItemRc :: new (sp :: VRcMapped :: origin (& _self . self_weak . get () . unwrap () . upgrade () . unwrap ()) , _self . tree_index_of_first_child . get () + 5u32 - 1)) ;
                                 {
                                     let mut the_struct = sp :: LayoutInfo :: default () ;
                             ...
                             the_struct }
                         as _ , r#size : ({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_height }
                        ) . apply_pin (_self) . get () . get () as _ , r#spacing : 12f64 as _ , }
                     as _ , sp :: Slice :: from_slice (& []) as _)) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layoutinfo_h }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#box_layout_info_ortho (sp :: Slice :: from_slice (& [{
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                     ...
                     , {
                         ...
                         the_struct . r#constraint = {
                             let r#layout_info = sp :: Item :: layout_info (({
                                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#empty_18 }
                            ) . apply_pin (_self) , sp :: Orientation :: Horizontal , & _self . globals . get () . unwrap () . window_adapter_impl () , & & sp :: ItemRc :: new (sp :: VRcMapped :: origin (& _self . self_weak . get () . unwrap () . upgrade () . unwrap ()) , _self . tree_index_of_first_child . get () + 5u32 - 1)) ;
                             {
                                 let mut the_struct = sp :: LayoutInfo :: default () ;
                                 the_struct . r#max = (r#layout_info . clone ()) . r#max as _ ;
                                 the_struct . r#max_percent = (r#layout_info . clone ()) . r#max_percent as _ ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layoutinfo_v }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#box_layout_info (sp :: Slice :: from_slice (& [{
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_28_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ({
                         let r#tmp_root_13_vertical_bar_24_maximum = ({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_maximum }
                        ) . apply_pin (_self) . get () . get () ;
                         ((if ((r#tmp_root_13_vertical_bar_24_maximum . clone ()) as f64) <= ((((0f64) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64)) as f64) {
                             (0f64) as _ }
                         else {
                             {
                                 let r#tmp_root_13_vertical_bar_24_page_size = ({
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_height }
                                ) . apply_pin (_self) . get () . get () ;
                                 ((((32f64 as sp :: Coord) . min (({
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_height }
                                ) . apply_pin (_self) . get () . get () as sp :: Coord) as sp :: Coord) . max ((((((({
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_height }
                                ) . apply_pin (_self) . get () . get ()) as f64) - ((4f64) as f64)) as f64) * ((((r#tmp_root_13_vertical_bar_24_page_size . clone ()) as f64) / ((((r#tmp_root_13_vertical_bar_24_maximum . clone ()) as f64) + ((r#tmp_root_13_vertical_bar_24_page_size . clone ()) as f64)) as f64)) as f64)) as sp :: Coord)) as f64) * ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                             }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_28_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_width }
                    ) . apply_pin (_self) . get () . get ()) as f64) - ((((2f64) as f64) * ((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_pad }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_28_x }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_width }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_28_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_35_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_height }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_35_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ({
                         let r#tmp_root_13_horizontal_bar_31_maximum = ({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_maximum }
                        ) . apply_pin (_self) . get () . get () ;
                         ((if ((r#tmp_root_13_horizontal_bar_31_maximum . clone ()) as f64) <= ((((0f64) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64)) as f64) {
                             (0f64) as _ }
                         else {
                             {
                                 let r#tmp_root_13_horizontal_bar_31_page_size = ({
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_width }
                                ) . apply_pin (_self) . get () . get () ;
                                 ((((32f64 as sp :: Coord) . min (({
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
                                     ...
                                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
                                ) . apply_pin (_self) . get () . get ()) as f64) - ((4f64) as f64)) as f64) * ((r#tmp_root_13_horizontal_bar_31_page_size . clone ()) as f64)) as f64) / ((((r#tmp_root_13_horizontal_bar_31_maximum . clone ()) as f64) + ((r#tmp_root_13_horizontal_bar_31_page_size . clone ()) as f64)) as f64)) as sp :: Coord)) as f64) * ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                             }
                        ) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                     as sp :: Coord)) as _ }
                 , {
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_35_x }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((2f64) as f64) + ((((((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_35_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_height }
                 ...
                 }
             {
                 ...
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_pad }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#touch_area_29 }
                     + sp :: r#TouchArea :: FIELD_OFFSETS . r#has_hover) . apply_pin (_self) . get () {
                         (1f64) as _ }
                     else {
                         0f64 }
             ...
             {
                 # [allow (unreachable_code , unused)] slint :: private_unstable_api :: set_callback_handler (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_scrolled }
                ) . apply_pin (_self) , & self_rc , {
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         ({
                 ...
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_visible }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     ({
                         let r#tmp_root_13_empty_18_vertical_scrollbar_policy = ({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_vertical_scrollbar_policy }
                        ) . apply_pin (_self) . get () ;
                         ((((r#tmp_root_13_empty_18_vertical_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AlwaysOn)))) || ((((((r#tmp_root_13_empty_18_vertical_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AsNeeded)))) && ((((({
                             * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_maximum }
                        ) . apply_pin (_self) . get () . get ()) as f64) > ((0f64) as f64))))) }
                    ) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_x }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((((({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_width }
             ...
             + sp :: r#SimpleText :: FIELD_OFFSETS . r#text) . apply_pin (_self) . set ({
                 (sp :: SharedString :: from ("Detected disks")) as sp :: SharedString }
            ) ;
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#text_14 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#_visibility_15 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((! sp :: ApproxEq :: < f64 > :: approx_eq (& (match & ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_items }
                    ) . apply_pin (_self) . get () {
                         x => {
             ...
             ({
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#text_16 }
             + sp :: r#SimpleText :: FIELD_OFFSETS . r#text) . apply_pin (_self) . set ({
                 (sp :: SharedString :: from ("No disks detected.")) as sp :: SharedString }
            ) ;
             ({
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#text_16 }
             + sp :: r#SimpleText :: FIELD_OFFSETS . r#vertical_alignment) . apply_pin (_self) . set ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#_visibility_17 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((! ! sp :: ApproxEq :: < f64 > :: approx_eq (& (match & ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_items }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#vertical_bar_visibility_23 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((! ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_visible }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#vertical_bar_24 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#vertical_bar_clip_25 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (true) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#border_26 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#touch_area_29 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#thumb_opacity_27 }
                             ...
                             + sp :: r#TouchArea :: FIELD_OFFSETS . r#pressed) . apply_pin (_self) . get ())) {
                                 ({
                                     ...
                                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_y) . apply_pin (_self) . set (sp :: LogicalLength :: new ((- (0f64 as sp :: Coord) . max ((({
                                         ...
                                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_touch_area_29_pressed_value }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#horizontal_bar_visibility_30 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((! ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_visible }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#horizontal_bar_31 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#touch_area_36 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#horizontal_bar_clip_32 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (true) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#border_33 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#touch_area_36 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#thumb_opacity_34 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (0.6f64) as _ }
                ) ;
                             ...
                             + sp :: r#TouchArea :: FIELD_OFFSETS . r#pressed) . apply_pin (_self) . get ())) {
                                 ({
                                     ...
                                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_x) . apply_pin (_self) . set (sp :: LogicalLength :: new ((- (0f64 as sp :: Coord) . max ((({
                                         ...
                                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_touch_area_36_pressed_value }
         ...
         fn visit_dynamic_children (self : :: core :: pin :: Pin < & Self > , dyn_index : u32 , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             ...
             match dyn_index {
                 0u32 => {
                     InnerDiskContent_root_13 :: FIELD_OFFSETS . repeater0 . apply_pin (_self) . ensure_updated_listview (|| {
                         InnerComponent_diskrow_21 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into () }
                     , ({
                         * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#flickable_19 }
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             ...
             let (h , w , x , y) = match index {
                 0u32 => (({
                     ...
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layout_cache }
                ) . apply_pin (_self) . get () [0usize] as sp :: Coord ,) , 2u32 => (0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 3u32 => (0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 4u32 => (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layout_cache }
                ) . apply_pin (_self) . get () [3usize] as sp :: Coord , (((((({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_width }
                ) . apply_pin (_self) . get () . get ()) as f64) - ((16f64) as f64)) as f64) - ((16f64) as f64)) as sp :: Coord , 16f64 as sp :: Coord , ({
                     ...
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_layout_cache }
                ) . apply_pin (_self) . get () [4usize] as sp :: Coord ,) , 6u32 => (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_height }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_width }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , 2f64 as sp :: Coord , 2f64 as sp :: Coord ,) , 7u32 => (0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 8u32 => (0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 9u32 => (0f64 as sp :: Coord , ({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#flickable_19 }
                 ...
                 + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_x) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_flickable_viewport_20_y }
                     ...
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_x }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , 0f64 as sp :: Coord ,) , 12u32 => (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_height }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_width }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 13u32 => (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_vertical_bar_24_height }
                     ...
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 19u32 => (0.8f64 as sp :: Coord , ({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
                     ...
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_horizontal_bar_31_width }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 22u32 => (({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_35_height }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_thumb_35_width }
         ...
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             # ! [allow (unused)] let _self = self ;
             match index {
                 1u32 => sp :: r#AccessibleRole :: r#Text , 4u32 => sp :: r#AccessibleRole :: r#Text , 5u32 => sp :: r#AccessibleRole :: r#List , _ => sp :: AccessibleRole :: default () , }
             }
         fn accessible_string_property (self : :: core :: pin :: Pin < & Self > , index : u32 , what : sp :: AccessibleStringProperty ,) -> sp :: Option < sp :: SharedString > {
             # ! [allow (unused)] let _self = self ;
             match (index , what) {
                 (1u32 , sp :: AccessibleStringProperty :: r#Label) => sp :: Some (sp :: SharedString :: from ("Detected disks")) , (4u32 , sp :: AccessibleStringProperty :: r#Label) => sp :: Some (sp :: SharedString :: from ("No disks detected.")) , _ => sp :: None , }
             }
         fn accessibility_action (self : :: core :: pin :: Pin < & Self > , index : u32 , action : & sp :: AccessibilityAction) {
             # ! [allow (unused)] let _self = self ;
             match (index , action) {
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] struct InnerComponent_diskrow_21 {
         r#diskrow_21 : InnerDiskRow_root_5 , r#model_data : sp :: Property < r#DiskItem > , r#model_index : sp :: Property < i32 > , r#diskrow_21_actual_y : sp :: Property < sp :: LogicalLength > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerComponent_diskrow_21 >> , parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerDiskContent_root_13 > , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerComponent_diskrow_21 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             _self . tree_index . set (tree_index) ;
             _self . tree_index_of_first_child . set (tree_index_of_first_child) ;
             InnerDiskRow_root_5 :: init (sp :: VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#diskrow_21 }
             . apply_pin (x)) , _self . globals . get () . unwrap () . clone () , tree_index , tree_index_of_first_child + 1u32 - 1) ;
             {
                 # [allow (unreachable_code , unused)] slint :: private_unstable_api :: set_callback_handler (({
                     InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#diskrow_21 }
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_activated }
                ) . apply_pin (_self) , & self_rc , {
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         ({
                             let _ = (_self . parent . upgrade () . as_ref () . map (| x | (InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_disk_selected) . apply_pin (x . as_pin_ref ()))) . map (| x | x . call (& (({
                                 * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#model_index }
                            ) . apply_pin (_self) . get () as _ ,))) ;
                             }
                        ) ;
                         }
                 ...
                 }
             {
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_label }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     ((({
                         * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#model_data }
                    ) . apply_pin (_self) . get ()) . r#label) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_path }
                     ...
                     ((({
                         * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#model_data }
                    ) . apply_pin (_self) . get ()) . r#path) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_selected }
                     ...
                     ((({
                         * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#model_data }
                    ) . apply_pin (_self) . get ()) . r#selected) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_size }
                     ...
                     ((({
                         * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#model_data }
                    ) . apply_pin (_self) . get ()) . r#size) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_width }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((_self . parent . upgrade () . as_ref () . map (| x | (InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord)) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_y }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#diskrow_21_actual_y }
         ...
         fn user_init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self >) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             InnerDiskRow_root_5 :: user_init (sp :: VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#diskrow_21 }
             . apply_pin (x)) ,) ;
             }
         fn visit_dynamic_children (self : :: core :: pin :: Pin < & Self > , dyn_index : u32 , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             ...
             let (h , w , x , y) = match index {
                 ...
                 + {
                     * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5_empty_6_layoutinfo_v }
                     ...
                     the_struct . r#stretch = 1f64 as _ ;
                     the_struct }
                )))) . r#preferred as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_empty_18_visible_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , ({
                     * & InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#diskrow_21_actual_y }
                ) . apply_pin (_self) . get () . get () as sp :: Coord ,) , 1u32 ..= 6u32 => return {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
         ...
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             ...
             match index {
                 0u32 => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
                 . apply_pin (_self) . accessible_role (0) , 1u32 ..= 6u32 => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
         ...
         fn accessible_string_property (self : :: core :: pin :: Pin < & Self > , index : u32 , what : sp :: AccessibleStringProperty ,) -> sp :: Option < sp :: SharedString > {
             ...
             match (index , what) {
                 (0u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
                 . apply_pin (_self) . accessible_string_property (0 , what) , (1u32 ..= 6u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
         ...
         fn accessibility_action (self : :: core :: pin :: Pin < & Self > , index : u32 , action : & sp :: AccessibilityAction) {
             ...
             match (index , action) {
                 (0u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
                 . apply_pin (_self) . accessibility_action (0 , action) , (1u32 ..= 6u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
         ...
         fn supported_accessibility_actions (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: SupportedAccessibilityAction {
             ...
             match index {
                 0u32 => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
                 . apply_pin (_self) . supported_accessibility_actions (0) , 1u32 ..= 6u32 => {
                     * & Self :: FIELD_OFFSETS . r#diskrow_21 }
     ...
     impl InnerComponent_diskrow_21 {
         fn new (parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerDiskContent_root_13 > ,) -> :: core :: result :: Result < sp :: VRc < sp :: ItemTreeVTable , Self > , slint :: PlatformError > {
             # ! [allow (unused)] slint :: private_unstable_api :: ensure_backend () ? ;
             let mut _self = Self :: default () ;
             _self . parent = parent . clone () as sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerDiskContent_root_13 > ;
         ...
         fn item_tree () -> & 'static [sp :: ItemTreeNode] {
             ...
             , sp :: ItemTreeNode :: Item {
                 is_accessible : true , children_count : 0u32 , children_index : 7u32 , parent_index : 0u32 , item_array_index : 3u32 , }
             , sp :: ItemTreeNode :: Item {
                 is_accessible : false , children_count : 0u32 , children_index : 7u32 , parent_index : 0u32 , item_array_index : 4u32 , }
             , sp :: ItemTreeNode :: Item {
                 is_accessible : true , children_count : 0u32 , children_index : 7u32 , parent_index : 1u32 , item_array_index : 5u32 , }
             , sp :: ItemTreeNode :: Item {
                 is_accessible : true , children_count : 0u32 , children_index : 7u32 , parent_index : 1u32 , item_array_index : 6u32 , }
            ] ;
             & ITEM_TREE }
         fn item_array () -> & 'static [sp :: VOffset < Self , sp :: ItemVTable , sp :: AllowPin >] {
             static ITEM_ARRAY : sp :: OnceBox < [sp :: VOffset < InnerComponent_diskrow_21 , sp :: ItemVTable , sp :: AllowPin > ;
             ...
             + {
                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#root_5 }
                 ...
                 InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#diskrow_21 }
             + {
                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#empty_7 }
            ) , sp :: VOffset :: new ({
                 InnerComponent_diskrow_21 :: FIELD_OFFSETS . r#diskrow_21 }
             + {
                 * & InnerDiskRow_root_5 :: FIELD_OFFSETS . r#rectangle_10 }
     ...
     const _ : () = {
         ...
         ItemTreeVTable_static ! (static VT for self :: InnerComponent_diskrow_21) ;
         }
     ;
     impl sp :: PinnedDrop for InnerComponent_diskrow_21 {
         fn drop (self : :: core :: pin :: Pin < & mut InnerComponent_diskrow_21 >) {
     ...
     impl sp :: ItemTree for InnerComponent_diskrow_21 {
         fn visit_children_item (self : :: core :: pin :: Pin < & Self > , index : isize , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             ...
             # [allow (unused)] fn visit_dynamic (_self : :: core :: pin :: Pin < & InnerComponent_diskrow_21 > , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ > , dyn_index : u32) -> sp :: VisitChildrenResult {
     ...
     impl sp :: RepeatedItemTree for InnerComponent_diskrow_21 {
         type Data = r#DiskItem ;
         ...
         fn init (& self) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             InnerComponent_diskrow_21 :: user_init (sp :: VRcMapped :: map (self_rc , | x | x) ,) ;
             }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] pub struct InnerButton_root_37 {
         r#root_37 : sp :: r#Empty , r#_opacity_38 : sp :: r#Opacity , r#rectangle_39 : sp :: r#BasicBorderRectangle , r#i_touch_area_62 : sp :: r#TouchArea , r#i_focus_scope_63 : sp :: r#FocusScope , r#root_37_background : sp :: Property < slint :: Brush > , r#root_37_checked : sp :: Property < bool > , r#root_37_height : sp :: Property < sp :: LogicalLength > , r#root_37_i_layout_55_layout_cache : sp :: Property < sp :: SharedVector < sp :: Coord , > > , r#root_37_i_layout_55_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#root_37_i_layout_55_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , r#root_37_icon : sp :: Property < sp :: Image > , r#root_37_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#root_37_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , r#root_37_pressed : sp :: Property < bool > , r#root_37_rectangle_39_x : sp :: Property < sp :: LogicalLength > , r#root_37_rectangle_39_y : sp :: Property < sp :: LogicalLength > , r#root_37_state : sp :: Property < i32 > , r#root_37_text : sp :: Property < sp :: SharedString > , r#root_37_text_color : sp :: Property < slint :: Brush > , r#root_37_width : sp :: Property < sp :: LogicalLength > , r#root_37_x : sp :: Property < sp :: LogicalLength > , r#root_37_y : sp :: Property < sp :: LogicalLength > , r#root_37_accessible_action_default : sp :: Callback < () , () > , r#root_37_clicked : sp :: Callback < () , () > , repeater0 : sp :: Conditional < InnerComponent__shadow_40 > , repeater1 : sp :: Conditional < InnerComponent__shadow_49 > , repeater2 : sp :: Conditional < InnerComponent__opacity_56 > , repeater3 : sp :: Conditional < InnerComponent__opacity_59 > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerButton_root_37 >> , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerButton_root_37 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_background }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_i_layout_55_layout_cache }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ({
                         ...
                         InnerButton_root_37 :: FIELD_OFFSETS . repeater2 . apply_pin (_self) . ensure_updated (|| {
                             InnerComponent__opacity_56 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into () }
                        ) ;
                         ...
                         InnerButton_root_37 :: FIELD_OFFSETS . repeater3 . apply_pin (_self) . ensure_updated (|| {
                             InnerComponent__opacity_59 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into () }
                        ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_pressed }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((((({
                         * & InnerButton_root_37 :: FIELD_OFFSETS . r#i_focus_scope_63 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_rectangle_39_x }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((({
                         * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_rectangle_39_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_text_color }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ({
                         let r#tmp_root_37_state = ({
         ...
         fn visit_dynamic_children (self : :: core :: pin :: Pin < & Self > , dyn_index : u32 , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             ...
             match dyn_index {
                 0u32 => {
                     InnerButton_root_37 :: FIELD_OFFSETS . repeater0 . apply_pin (_self) . ensure_updated (|| InnerComponent__shadow_40 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into ()) ;
                     _self . repeater0 . visit (order , visitor) }
                 1u32 => {
                     InnerButton_root_37 :: FIELD_OFFSETS . repeater1 . apply_pin (_self) . ensure_updated (|| InnerComponent__shadow_49 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into ()) ;
                     _self . repeater1 . visit (order , visitor) }
                 2u32 => {
                     InnerButton_root_37 :: FIELD_OFFSETS . repeater2 . apply_pin (_self) . ensure_updated (|| InnerComponent__opacity_56 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into ()) ;
                     _self . repeater2 . visit (order , visitor) }
                 3u32 => {
                     InnerButton_root_37 :: FIELD_OFFSETS . repeater3 . apply_pin (_self) . ensure_updated (|| InnerComponent__opacity_59 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into ()) ;
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] struct InnerComponent__shadow_40 {
         r#_shadow_40 : sp :: r#BoxShadow , r#rectangle_41 : sp :: r#BasicBorderRectangle , r#_shadow_42 : sp :: r#BoxShadow , r#rectangle_43 : sp :: r#BasicBorderRectangle , r#_shadow_44 : sp :: r#BoxShadow , r#rectangle_45 : sp :: r#BasicBorderRectangle , r#_opacity_46 : sp :: r#Opacity , r#rectangle_47 : sp :: r#BasicBorderRectangle , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerComponent__shadow_40 >> , parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerButton_root_37 > , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerComponent__shadow_40 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
            ...
            ) ;
             {
                 ...
                 + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_background) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default ()) as _ }
                ) ;
                 }
             ({
                 * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#rectangle_41 }
             ...
             ({
                 * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#_shadow_42 }
             + sp :: r#BoxShadow :: FIELD_OFFSETS . r#blur) . apply_pin (_self) . set ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#rectangle_43 }
                 + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_background) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default ()) as _ }
                ) ;
             ...
             ({
                 * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#_shadow_44 }
             + sp :: r#BoxShadow :: FIELD_OFFSETS . r#blur) . apply_pin (_self) . set ({
                 (sp :: LogicalLength :: new (1f64 as sp :: Coord)) as sp :: LogicalLength }
            ) ;
             ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#rectangle_45 }
                 + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_background) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default ()) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#_opacity_46 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (0.17f64) as _ }
                ) ;
             ...
             ({
                 * & InnerComponent__shadow_40 :: FIELD_OFFSETS . r#rectangle_47 }
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             # ! [allow (unused)] let _self = self ;
             let (h , w , x , y) = match index {
                 0u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 1u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 2u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 3u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 4u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 5u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 6u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 7u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , _ => return :: core :: default :: Default :: default () }
             ;
             sp :: euclid :: rect (x , y , w , h) }
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             # ! [allow (unused)] let _self = self ;
     ...
     impl InnerComponent__shadow_40 {
         fn new (parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerButton_root_37 > ,) -> :: core :: result :: Result < sp :: VRc < sp :: ItemTreeVTable , Self > , slint :: PlatformError > {
             # ! [allow (unused)] slint :: private_unstable_api :: ensure_backend () ? ;
             let mut _self = Self :: default () ;
             _self . parent = parent . clone () as sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerButton_root_37 > ;
             let self_rc = sp :: VRc :: new (_self) ;
             let self_dyn_rc = sp :: VRc :: into_dyn (self_rc . clone ()) ;
             let globals = parent . upgrade () . unwrap () . globals . get () . unwrap () . clone () ;
             sp :: register_item_tree (& self_dyn_rc , globals . maybe_window_adapter_impl ()) ;
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] struct InnerComponent__shadow_49 {
         r#_shadow_49 : sp :: r#BoxShadow , r#rectangle_50 : sp :: r#BasicBorderRectangle , r#_opacity_51 : sp :: r#Opacity , r#_shadow_52 : sp :: r#BoxShadow , r#rectangle_53 : sp :: r#BasicBorderRectangle , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerComponent__shadow_49 >> , parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerButton_root_37 > , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerComponent__shadow_49 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             ...
             _self . tree_index_of_first_child . set (tree_index_of_first_child) ;
             ({
                 * & InnerComponent__shadow_49 :: FIELD_OFFSETS . r#_shadow_49 }
             + sp :: r#BoxShadow :: FIELD_OFFSETS . r#blur) . apply_pin (_self) . set ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__shadow_49 :: FIELD_OFFSETS . r#rectangle_50 }
                 + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_background) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default ()) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__shadow_49 :: FIELD_OFFSETS . r#_opacity_51 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
             ...
             ({
                 * & InnerComponent__shadow_49 :: FIELD_OFFSETS . r#_shadow_52 }
             + sp :: r#BoxShadow :: FIELD_OFFSETS . r#blur) . apply_pin (_self) . set ({
                 (sp :: LogicalLength :: new (1f64 as sp :: Coord)) as sp :: LogicalLength }
            ) ;
             ({
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             # ! [allow (unused)] let _self = self ;
             let (h , w , x , y) = match index {
                 0u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 1u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 2u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 3u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , 4u32 => ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , _ => return :: core :: default :: Default :: default () }
             ;
             sp :: euclid :: rect (x , y , w , h) }
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             # ! [allow (unused)] let _self = self ;
     ...
     impl InnerComponent__shadow_49 {
         ...
         fn item_tree () -> & 'static [sp :: ItemTreeNode] {
             ...
             & ITEM_TREE }
         fn item_array () -> & 'static [sp :: VOffset < Self , sp :: ItemVTable , sp :: AllowPin >] {
             static ITEM_ARRAY : sp :: OnceBox < [sp :: VOffset < InnerComponent__shadow_49 , sp :: ItemVTable , sp :: AllowPin > ;
     ...
     const _ : () = {
         use slint :: private_unstable_api :: re_exports :: * ;
         ItemTreeVTable_static ! (static VT for self :: InnerComponent__shadow_49) ;
         }
     ;
     impl sp :: PinnedDrop for InnerComponent__shadow_49 {
         fn drop (self : :: core :: pin :: Pin < & mut InnerComponent__shadow_49 >) {
             sp :: vtable :: new_vref ! (let vref : VRef < sp :: ItemTreeVTable > for sp :: ItemTree = self . as_ref () . get_ref ()) ;
             if let Some (wa) = self . globals . get () . unwrap () . maybe_window_adapter_impl () {
                 sp :: unregister_item_tree (self . as_ref () , vref , Self :: item_array () , & wa) ;
                 }
     ...
     impl sp :: ItemTree for InnerComponent__shadow_49 {
         fn visit_children_item (self : :: core :: pin :: Pin < & Self > , index : isize , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             return sp :: visit_item_tree (self , & sp :: VRcMapped :: origin (& self . as_ref () . self_weak . get () . unwrap () . upgrade () . unwrap ()) , self . get_item_tree () . as_slice () , index , order , visitor , visit_dynamic) ;
             # [allow (unused)] fn visit_dynamic (_self : :: core :: pin :: Pin < & InnerComponent__shadow_49 > , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ > , dyn_index : u32) -> sp :: VisitChildrenResult {
                 _self . visit_dynamic_children (dyn_index , order , visitor) }
             }
         fn get_item_ref (self : :: core :: pin :: Pin < & Self > , index : u32) -> :: core :: pin :: Pin < sp :: ItemRef < '_ >> {
             match & self . get_item_tree () . as_slice () [index as usize] {
     ...
     impl sp :: RepeatedItemTree for InnerComponent__shadow_49 {
         type Data = () ;
         fn update (& self , _index : usize , _data : Self :: Data) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             let _self = self_rc . as_pin_ref () ;
         ...
         fn init (& self) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             InnerComponent__shadow_49 :: user_init (sp :: VRcMapped :: map (self_rc , | x | x) ,) ;
             }
         fn box_layout_data (self : :: core :: pin :: Pin < & Self > , o : sp :: Orientation) -> sp :: BoxLayoutCellData {
             sp :: BoxLayoutCellData {
                 constraint : self . as_ref () . layout_info (o) }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] struct InnerComponent__opacity_56 {
         r#_opacity_56 : sp :: r#Opacity , r#image_57 : sp :: r#ImageItem , r#_opacity_56_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#_opacity_56_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerComponent__opacity_56 >> , parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerButton_root_37 > , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerComponent__opacity_56 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             ...
             _self . tree_index_of_first_child . set (tree_index_of_first_child) ;
             {
                 let _ = (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_icon) . apply_pin (x . as_pin_ref ()))) . map (| x | sp :: Property :: link_two_way (({
                     * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#image_57 }
                 + sp :: r#ImageItem :: FIELD_OFFSETS . r#source) . apply_pin (_self) , x)) ;
                 }
             ;
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#_opacity_56_layoutinfo_h }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: Item :: layout_info (({
                         * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#image_57 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#_opacity_56_layoutinfo_v }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: Item :: layout_info (({
                         * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#image_57 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#_opacity_56 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if _self . parent . upgrade () . as_ref () . map (| x | ({
                         * & InnerButton_root_37 :: FIELD_OFFSETS . r#i_focus_scope_63 }
                 ...
                 }
             {
                 ...
                 + sp :: r#ImageItem :: FIELD_OFFSETS . r#height) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (((((((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get ()) as f64) - ((4f64) as f64)) as f64) - ((4f64) as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             ({
                 * & InnerComponent__opacity_56 :: FIELD_OFFSETS . r#image_57 }
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             # ! [allow (unused)] let _self = self ;
             let (h , w , x , y) = match index {
                 0u32 => (((((((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get ()) as f64) - ((4f64) as f64)) as f64) - ((4f64) as f64)) as sp :: Coord , 13f64 as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_i_layout_55_layout_cache) . apply_pin (x . as_pin_ref ()))) . map (| x | {
                     let cache = x . get () ;
                     * cache . get ((cache [0usize] as usize) + 0f64 as usize * 2) . unwrap_or (& (0 as sp :: Coord)) }
                ) . unwrap_or_default () as sp :: Coord , 4f64 as sp :: Coord ,) , 1u32 => (((((((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get ()) as f64) - ((4f64) as f64)) as f64) - ((4f64) as f64)) as sp :: Coord , 13f64 as sp :: Coord , 0f64 as sp :: Coord , 0f64 as sp :: Coord ,) , _ => return :: core :: default :: Default :: default () }
             ;
             sp :: euclid :: rect (x , y , w , h) }
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             # ! [allow (unused)] let _self = self ;
     ...
     impl InnerComponent__opacity_56 {
         ...
         fn item_tree () -> & 'static [sp :: ItemTreeNode] {
             ...
             & ITEM_TREE }
         fn item_array () -> & 'static [sp :: VOffset < Self , sp :: ItemVTable , sp :: AllowPin >] {
             static ITEM_ARRAY : sp :: OnceBox < [sp :: VOffset < InnerComponent__opacity_56 , sp :: ItemVTable , sp :: AllowPin > ;
     ...
     const _ : () = {
         use slint :: private_unstable_api :: re_exports :: * ;
         ItemTreeVTable_static ! (static VT for self :: InnerComponent__opacity_56) ;
         }
     ;
     impl sp :: PinnedDrop for InnerComponent__opacity_56 {
         fn drop (self : :: core :: pin :: Pin < & mut InnerComponent__opacity_56 >) {
             sp :: vtable :: new_vref ! (let vref : VRef < sp :: ItemTreeVTable > for sp :: ItemTree = self . as_ref () . get_ref ()) ;
             if let Some (wa) = self . globals . get () . unwrap () . maybe_window_adapter_impl () {
                 sp :: unregister_item_tree (self . as_ref () , vref , Self :: item_array () , & wa) ;
                 }
     ...
     impl sp :: ItemTree for InnerComponent__opacity_56 {
         fn visit_children_item (self : :: core :: pin :: Pin < & Self > , index : isize , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             return sp :: visit_item_tree (self , & sp :: VRcMapped :: origin (& self . as_ref () . self_weak . get () . unwrap () . upgrade () . unwrap ()) , self . get_item_tree () . as_slice () , index , order , visitor , visit_dynamic) ;
             # [allow (unused)] fn visit_dynamic (_self : :: core :: pin :: Pin < & InnerComponent__opacity_56 > , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ > , dyn_index : u32) -> sp :: VisitChildrenResult {
                 _self . visit_dynamic_children (dyn_index , order , visitor) }
             }
         fn get_item_ref (self : :: core :: pin :: Pin < & Self > , index : u32) -> :: core :: pin :: Pin < sp :: ItemRef < '_ >> {
             match & self . get_item_tree () . as_slice () [index as usize] {
     ...
     impl sp :: RepeatedItemTree for InnerComponent__opacity_56 {
         type Data = () ;
         fn update (& self , _index : usize , _data : Self :: Data) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             let _self = self_rc . as_pin_ref () ;
         ...
         fn init (& self) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             InnerComponent__opacity_56 :: user_init (sp :: VRcMapped :: map (self_rc , | x | x) ,) ;
             }
         fn box_layout_data (self : :: core :: pin :: Pin < & Self > , o : sp :: Orientation) -> sp :: BoxLayoutCellData {
             sp :: BoxLayoutCellData {
                 constraint : self . as_ref () . layout_info (o) }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] struct InnerComponent__opacity_59 {
         r#_opacity_59 : sp :: r#Opacity , r#text_60 : sp :: r#SimpleText , r#_opacity_59_layoutinfo_h : sp :: Property < sp :: LayoutInfo > , r#_opacity_59_layoutinfo_v : sp :: Property < sp :: LayoutInfo > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerComponent__opacity_59 >> , parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerButton_root_37 > , globals : sp :: OnceCell < sp :: Rc < SharedGlobals >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl InnerComponent__opacity_59 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#_opacity_59_layoutinfo_h }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: Item :: layout_info (({
                         * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#text_60 }
                    ) . apply_pin (_self) , sp :: Orientation :: Horizontal , & _self . globals . get () . unwrap () . window_adapter_impl () , & & sp :: ItemRc :: new (sp :: VRcMapped :: origin (& _self . self_weak . get () . unwrap () . upgrade () . unwrap ()) , _self . tree_index_of_first_child . get () + 1u32 - 1))) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#_opacity_59_layoutinfo_v }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: Item :: layout_info (({
                         * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#text_60 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#_opacity_59 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if _self . parent . upgrade () . as_ref () . map (| x | ({
                         * & InnerButton_root_37 :: FIELD_OFFSETS . r#i_focus_scope_63 }
                 ...
                 }
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#color) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_text_color) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default ()) as _ }
                 , {
                     let mut the_struct = sp :: PropertyAnimation :: default () ;
                     the_struct . r#delay = 0f64 as _ ;
                     the_struct . r#direction = sp :: r#AnimationDirection :: r#Normal as _ ;
            ...
            ) ;
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#text) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_text) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default ()) as _ }
                ) ;
                 }
             ({
                 * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#text_60 }
            ...
            ) ;
             {
                 ...
                 + sp :: r#SimpleText :: FIELD_OFFSETS . r#width) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_i_layout_55_layout_cache) . apply_pin (x . as_pin_ref ()))) . map (| x | {
                         let cache = x . get () ;
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             # ! [allow (unused)] let _self = self ;
             let (h , w , x , y) = match index {
                 0u32 => (((((((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get ()) as f64) - ((4f64) as f64)) as f64) - ((4f64) as f64)) as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_i_layout_55_layout_cache) . apply_pin (x . as_pin_ref ()))) . map (| x | {
                     let cache = x . get () ;
                     * cache . get ((cache [3usize] as usize) + 0f64 as usize * 2) . unwrap_or (& (0 as sp :: Coord)) }
                ) . unwrap_or_default () as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_i_layout_55_layout_cache) . apply_pin (x . as_pin_ref ()))) . map (| x | {
                     let cache = x . get () ;
                     * cache . get ((cache [2usize] as usize) + 0f64 as usize * 2) . unwrap_or (& (0 as sp :: Coord)) }
                ) . unwrap_or_default () as sp :: Coord , 4f64 as sp :: Coord ,) , 1u32 => (((((((_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_height) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get ()) as f64) - ((4f64) as f64)) as f64) - ((4f64) as f64)) as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_i_layout_55_layout_cache) . apply_pin (x . as_pin_ref ()))) . map (| x | {
                     let cache = x . get () ;
                     * cache . get ((cache [3usize] as usize) + 0f64 as usize * 2) . unwrap_or (& (0 as sp :: Coord)) }
     ...
     impl InnerComponent__opacity_59 {
         ...
         fn item_tree () -> & 'static [sp :: ItemTreeNode] {
             ...
             & ITEM_TREE }
         fn item_array () -> & 'static [sp :: VOffset < Self , sp :: ItemVTable , sp :: AllowPin >] {
             static ITEM_ARRAY : sp :: OnceBox < [sp :: VOffset < InnerComponent__opacity_59 , sp :: ItemVTable , sp :: AllowPin > ;
             2usize] > = sp :: OnceBox :: new () ;
             & * ITEM_ARRAY . get_or_init (|| sp :: vec ! [sp :: VOffset :: new ({
                 * & InnerComponent__opacity_59 :: FIELD_OFFSETS . r#_opacity_59 }
            ) , sp :: VOffset :: new ({
     ...
     const _ : () = {
         use slint :: private_unstable_api :: re_exports :: * ;
         ItemTreeVTable_static ! (static VT for self :: InnerComponent__opacity_59) ;
         }
     ;
     impl sp :: PinnedDrop for InnerComponent__opacity_59 {
         fn drop (self : :: core :: pin :: Pin < & mut InnerComponent__opacity_59 >) {
             sp :: vtable :: new_vref ! (let vref : VRef < sp :: ItemTreeVTable > for sp :: ItemTree = self . as_ref () . get_ref ()) ;
             if let Some (wa) = self . globals . get () . unwrap () . maybe_window_adapter_impl () {
                 sp :: unregister_item_tree (self . as_ref () , vref , Self :: item_array () , & wa) ;
                 }
     ...
     impl sp :: ItemTree for InnerComponent__opacity_59 {
         fn visit_children_item (self : :: core :: pin :: Pin < & Self > , index : isize , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             return sp :: visit_item_tree (self , & sp :: VRcMapped :: origin (& self . as_ref () . self_weak . get () . unwrap () . upgrade () . unwrap ()) , self . get_item_tree () . as_slice () , index , order , visitor , visit_dynamic) ;
             # [allow (unused)] fn visit_dynamic (_self : :: core :: pin :: Pin < & InnerComponent__opacity_59 > , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ > , dyn_index : u32) -> sp :: VisitChildrenResult {
                 _self . visit_dynamic_children (dyn_index , order , visitor) }
             }
         fn get_item_ref (self : :: core :: pin :: Pin < & Self > , index : u32) -> :: core :: pin :: Pin < sp :: ItemRef < '_ >> {
             match & self . get_item_tree () . as_slice () [index as usize] {
     ...
     impl sp :: RepeatedItemTree for InnerComponent__opacity_59 {
         type Data = () ;
         fn update (& self , _index : usize , _data : Self :: Data) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             let _self = self_rc . as_pin_ref () ;
         ...
         fn init (& self) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             InnerComponent__opacity_59 :: user_init (sp :: VRcMapped :: map (self_rc , | x | x) ,) ;
             }
         fn box_layout_data (self : :: core :: pin :: Pin < & Self > , o : sp :: Orientation) -> sp :: BoxLayoutCellData {
             sp :: BoxLayoutCellData {
                 constraint : self . as_ref () . layout_info (o) }
     ...
     impl InnerAppWindow {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             ...
             _self . repeater0 . set_model_binding ({
                 ...
                 move || {
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_steps }
                    ) . apply_pin (_self) . get ()) as _ }
                 }
            ) ;
                     ...
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             ...
                             the_struct . r#constraint = ((({
                                 ...
                                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_68_layoutinfo_v }
                            ) . apply_pin (_self) . get ()))) as _ ;
                             the_struct }
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_66_layoutinfo_h }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#box_layout_info_ortho (sp :: Slice :: from_slice (& [{
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                         the_struct . r#constraint = ((({
                             ...
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_68_layoutinfo_h }
                        ) . apply_pin (_self) . get ()))) as _ ;
                         the_struct }
                     , {
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_66_layoutinfo_v }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#box_layout_info (sp :: Slice :: from_slice (& [{
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_68_layout_cache }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                         ...
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = ({
                                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_70_layoutinfo_v }
                            ) . apply_pin (_self) . get () as _ ;
                             the_struct }
                        ]) as _ , r#padding : {
                             let mut the_struct = sp :: Padding :: default () ;
                 ...
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_68_layoutinfo_h }
                     ...
                     , {
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                         the_struct . r#constraint = ({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_70_layoutinfo_h }
                        ) . apply_pin (_self) . get () as _ ;
                         the_struct }
                    ]) as _ , & {
                         let mut the_struct = sp :: Padding :: default () ;
                     ...
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             ...
                             the_struct . r#constraint = {
                                 let r#layout_info = (({
                                     ...
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_72_layoutinfo_h }
                                ) . apply_pin (_self) . get ())) ;
                                 {
                                     let mut the_struct = sp :: LayoutInfo :: default () ;
                         ...
                         , {
                             ...
                             the_struct . r#constraint = ((({
                                 ...
                                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_94_layoutinfo_h }
                            ) . apply_pin (_self) . get ()))) as _ ;
                             the_struct }
                        ]) as _ , r#padding : {
                             let mut the_struct = sp :: Padding :: default () ;
                     ...
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_70_layoutinfo_v }
                     ...
                     (sp :: r#box_layout_info_ortho (sp :: Slice :: from_slice (& [{
                         ...
                         the_struct . r#constraint = ((({
                             ...
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_72_layoutinfo_v }
                        ) . apply_pin (_self) . get ()))) as _ ;
                         the_struct }
                     , {
                         let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                         the_struct . r#constraint = ((({
                             ...
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_94_layoutinfo_v }
                        ) . apply_pin (_self) . get ()))) as _ ;
                         the_struct }
                    ]) as _ , & {
                         let mut the_struct = sp :: Padding :: default () ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_72_layout_cache }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerAppWindow :: FIELD_OFFSETS . r#text_73 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_horizontal_scrollbar_policy }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#ScrollBarPolicy :: r#AsNeeded) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_vertical_scrollbar_policy }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: r#ScrollBarPolicy :: r#AsNeeded) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_72_layout_cache }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ...
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_94_layout_cache }
                     ...
                     (sp :: r#solve_box_layout (& sp :: BoxLayoutData {
                         r#alignment : sp :: r#LayoutAlignment :: r#Stretch as _ , r#cells : sp :: Slice :: from_slice (& [{
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerAppWindow :: FIELD_OFFSETS . r#text_95 }
                         ...
                         , {
                             let mut the_struct = sp :: BoxLayoutCellData :: default () ;
                             the_struct . r#constraint = sp :: Item :: layout_info (({
                                 * & InnerAppWindow :: FIELD_OFFSETS . r#text_96 }
            ...
            ) ;
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_92 }
                     + sp :: r#TouchArea :: FIELD_OFFSETS . r#has_hover) . apply_pin (_self) . get () {
                         (20f64) as _ }
                     else {
                         12f64 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_maximum }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#flickable_75 }
                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_width) . apply_pin (_self) . get () . get ()) as f64) - ((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_width }
                    ) . apply_pin (_self) . get () . get ()) as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_pad }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_92 }
             ...
             {
                 # [allow (unreachable_code , unused)] slint :: private_unstable_api :: set_callback_handler (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_scrolled }
                ) . apply_pin (_self) , & self_rc , {
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_visible }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ({
                         let r#tmp_root_64_empty_74_horizontal_scrollbar_policy = ({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_horizontal_scrollbar_policy }
                        ) . apply_pin (_self) . get () ;
                         ((((r#tmp_root_64_empty_74_horizontal_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AlwaysOn)))) || ((((((r#tmp_root_64_empty_74_horizontal_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AsNeeded)))) && ((((({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_maximum }
                        ) . apply_pin (_self) . get () . get ()) as f64) > ((0f64) as f64))))) }
                    ) as _ }
                ) ;
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_visible }
                    ) . apply_pin (_self) . get () {
                         ((((188f64) as f64) - ((({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_width }
                        ) . apply_pin (_self) . get () . get ()) as f64))) as _ }
                     else {
                         188f64 }
                     as sp :: Coord)) as _ }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_72_layout_cache }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_layoutinfo_v }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((((sp :: Item :: layout_info (({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64 }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_84_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ({
                         let r#tmp_root_64_vertical_bar_80_maximum = ({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_maximum }
                        ) . apply_pin (_self) . get () . get () ;
                         ((if ((r#tmp_root_64_vertical_bar_80_maximum . clone ()) as f64) <= ((((0f64) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64)) as f64) {
                             (0f64) as _ }
                         else {
                             {
                                 let r#tmp_root_64_vertical_bar_80_page_size = ({
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_height }
                                ) . apply_pin (_self) . get () . get () ;
                                 ((((32f64 as sp :: Coord) . min (({
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_height }
                                ) . apply_pin (_self) . get () . get () as sp :: Coord) as sp :: Coord) . max ((((((({
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_height }
                                ) . apply_pin (_self) . get () . get ()) as f64) - ((4f64) as f64)) as f64) * ((((r#tmp_root_64_vertical_bar_80_page_size . clone ()) as f64) / ((((r#tmp_root_64_vertical_bar_80_maximum . clone ()) as f64) + ((r#tmp_root_64_vertical_bar_80_page_size . clone ()) as f64)) as f64)) as f64)) as sp :: Coord)) as f64) * ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                             }
                        ) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                     as sp :: Coord)) as _ }
                 , {
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_84_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_width }
                    ) . apply_pin (_self) . get () . get ()) as f64) - ((((2f64) as f64) * ((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_pad }
                    ) . apply_pin (_self) . get () . get ()) as f64)) as f64)) as sp :: Coord)) as _ }
                 , {
                     let mut the_struct = sp :: PropertyAnimation :: default () ;
                     the_struct . r#delay = 0f64 as _ ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_84_x }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_width }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_84_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((2f64) as f64) + ((((((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_height }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_91_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_height }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_91_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ({
                         let r#tmp_root_64_horizontal_bar_87_maximum = ({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_maximum }
                        ) . apply_pin (_self) . get () . get () ;
                         ((if ((r#tmp_root_64_horizontal_bar_87_maximum . clone ()) as f64) <= ((((0f64) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64)) as f64) {
                             (0f64) as _ }
                         else {
                             {
                                 let r#tmp_root_64_horizontal_bar_87_page_size = ({
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_width }
                                ) . apply_pin (_self) . get () . get () ;
                                 ((((32f64 as sp :: Coord) . min (({
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_width }
                                     ...
                                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_width }
                                ) . apply_pin (_self) . get () . get ()) as f64) - ((4f64) as f64)) as f64) * ((r#tmp_root_64_horizontal_bar_87_page_size . clone ()) as f64)) as f64) / ((((r#tmp_root_64_horizontal_bar_87_maximum . clone ()) as f64) + ((r#tmp_root_64_horizontal_bar_87_page_size . clone ()) as f64)) as f64)) as sp :: Coord)) as f64) * ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                             }
                        ) as f64) / ((sp :: WindowInner :: from_pub (& _self . globals . get () . unwrap () . window_adapter_impl () . window ()) . scale_factor ()) as f64) }
                     as sp :: Coord)) as _ }
                 , {
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_91_x }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((2f64) as f64) + ((((((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_width }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_thumb_91_y }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((((({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_height }
                 ...
                 }
             {
                 ...
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_pad }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_85 }
                     + sp :: r#TouchArea :: FIELD_OFFSETS . r#has_hover) . apply_pin (_self) . get () {
                         (1f64) as _ }
                     else {
                         0f64 }
             ...
             {
                 # [allow (unreachable_code , unused)] slint :: private_unstable_api :: set_callback_handler (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_scrolled }
                ) . apply_pin (_self) , & self_rc , {
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         ({
                 ...
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_visible }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     ({
                         let r#tmp_root_64_empty_74_vertical_scrollbar_policy = ({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_vertical_scrollbar_policy }
                        ) . apply_pin (_self) . get () ;
                         ((((r#tmp_root_64_empty_74_vertical_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AlwaysOn)))) || ((((((r#tmp_root_64_empty_74_vertical_scrollbar_policy . clone ())) == ((sp :: r#ScrollBarPolicy :: r#AsNeeded)))) && ((((({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_maximum }
                        ) . apply_pin (_self) . get () . get ()) as f64) > ((0f64) as f64))))) }
                    ) as _ }
                ) ;
             ...
             ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#rectangle_71 }
             + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) . set ({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#vertical_bar_visibility_79 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((! ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_visible }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#vertical_bar_80 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_85 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#vertical_bar_clip_81 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (true) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#border_82 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_85 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#thumb_opacity_83 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (0.6f64) as _ }
                ) ;
                             ...
                             + sp :: r#TouchArea :: FIELD_OFFSETS . r#pressed) . apply_pin (_self) . get ())) {
                                 ({
                                     ...
                                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_y) . apply_pin (_self) . set (sp :: LogicalLength :: new ((- (0f64 as sp :: Coord) . max ((({
                                         ...
                                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_touch_area_85_pressed_value }
                                    ) . apply_pin (_self) . get () . get ()) as f64) + ((if false {
                                         ((((((({
                                             * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_85 }
                                         + sp :: r#TouchArea :: FIELD_OFFSETS . r#mouse_x) . apply_pin (_self) . get () . get ()) as f64) - ((({
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#horizontal_bar_visibility_86 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     ((! ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_horizontal_bar_87_visible }
                 ...
                 }
             {
                 let _self = self_rc . as_pin_ref () ;
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#horizontal_bar_87 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_92 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#horizontal_bar_clip_88 }
                 + sp :: r#Clip :: FIELD_OFFSETS . r#clip) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (true) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#border_89 }
                 + sp :: r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (if sp :: ApproxEq :: < f64 > :: approx_eq (& (if ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_92 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#thumb_opacity_90 }
                 + sp :: r#Opacity :: FIELD_OFFSETS . r#opacity) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (0.6f64) as _ }
                ) ;
                             ...
                             + sp :: r#TouchArea :: FIELD_OFFSETS . r#pressed) . apply_pin (_self) . get ())) {
                                 ({
                                     ...
                                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_x) . apply_pin (_self) . set (sp :: LogicalLength :: new ((- (0f64 as sp :: Coord) . max ((({
                                         ...
                                         * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_touch_area_92_pressed_value }
                                    ) . apply_pin (_self) . get () . get ()) as f64) + ((if true {
                                         ((((((({
                                             * & InnerAppWindow :: FIELD_OFFSETS . r#touch_area_92 }
                                         + sp :: r#TouchArea :: FIELD_OFFSETS . r#mouse_x) . apply_pin (_self) . get () . get ()) as f64) - ((({
             ...
             ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#rectangle_93 }
             + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) . set ({
                 (slint :: Brush :: SolidColor (sp :: Color :: from_argb_encoded ((4294967295f64) as u32))) as slint :: Brush }
            ) ;
             ({
             ...
             ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#rectangle_97 }
             + sp :: r#BasicBorderRectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) . set ({
                 ...
                 }
             {
                 ...
                 + {
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_disk_selected }
                ) . apply_pin (_self) , & self_rc , {
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         (({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_select_disk }
            ...
            ) ;
             {
                 ...
                 + {
                     * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13_items }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: ModelRc :: new (sp :: VecModel :: < r#DiskItem > :: from (sp :: vec ! []))) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_clicked }
                     ...
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         (({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_request_cancel }
                        ) . apply_pin (_self) . call (& ())) ;
                         }
                     }
                ) ;
                 ...
                 + {
                     * & InnerButton_root_37 :: FIELD_OFFSETS . r#root_37_clicked }
                     ...
                     move | self_rc , args | {
                         let _self = self_rc . as_pin_ref () ;
                         (({
                             * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_request_back }
                        ) . apply_pin (_self) . call (& ())) ;
                         }
                     }
                ) ;
         ...
         fn user_init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self >) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             InnerDiskContent_root_13 :: user_init (sp :: VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#diskcontent_99 }
             . apply_pin (x)) ,) ;
             ...
             match dyn_index {
                 0u32 => {
                     InnerAppWindow :: FIELD_OFFSETS . repeater0 . apply_pin (_self) . ensure_updated_listview (|| {
                         InnerComponent_stepitem_77 :: new (_self . self_weak . get () . unwrap () . clone ()) . unwrap () . into () }
                     , ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#flickable_75 }
                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_width) . apply_pin (_self) , ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#flickable_75 }
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             ...
             let (h , w , x , y) = match index {
                 ...
                 + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_width) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#flickable_75 }
                 + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_x) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_flickable_viewport_76_y }
                ) . apply_pin (_self) . get () . get () as sp :: Coord ,) , 15u32 => (({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_height }
                ) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_vertical_bar_80_width }
     ...
     impl InnerComponent_stepitem_77 {
         fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , globals : sp :: Rc < SharedGlobals > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             let _ = _self . self_weak . set (sp :: VRcMapped :: downgrade (& self_rc)) ;
             let _ = _self . globals . set (globals) ;
             ...
             InnerStepItem_root_1 :: init (sp :: VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#stepitem_77 }
             . apply_pin (x)) , _self . globals . get () . unwrap () . clone () , tree_index , tree_index_of_first_child + 1u32 - 1) ;
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     InnerComponent_stepitem_77 :: FIELD_OFFSETS . r#stepitem_77 }
                 + {
                     * & InnerStepItem_root_1 :: FIELD_OFFSETS . r#root_1_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                 ...
                 }
             {
                 ...
                 + {
                     * & InnerStepItem_root_1 :: FIELD_OFFSETS . r#root_1_selected }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: ApproxEq :: < f64 > :: approx_eq (& (({
                         * & InnerComponent_stepitem_77 :: FIELD_OFFSETS . r#model_index }
                    ) . apply_pin (_self) . get () as f64) , & ((_self . parent . upgrade () . as_ref () . map (| x | (InnerAppWindow :: FIELD_OFFSETS . r#root_64_current_step_index) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () as f64))) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerStepItem_root_1 :: FIELD_OFFSETS . r#root_1_subtitle }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     ((({
                         * & InnerComponent_stepitem_77 :: FIELD_OFFSETS . r#model_data }
                 ...
                 }
             {
                 ...
                 + {
                     * & InnerStepItem_root_1 :: FIELD_OFFSETS . r#root_1_width }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((_self . parent . upgrade () . as_ref () . map (| x | (InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord)) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 + {
                     * & InnerStepItem_root_1 :: FIELD_OFFSETS . r#root_1_y }
                     ...
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((((({
                         * & InnerComponent_stepitem_77 :: FIELD_OFFSETS . r#stepitem_77_actual_y }
                    ) . apply_pin (_self) . get () . get ()) as f64) - ((_self . parent . upgrade () . as_ref () . map (| x | ({
                         * & InnerAppWindow :: FIELD_OFFSETS . r#flickable_75 }
                     + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_y) . apply_pin (x . as_pin_ref ())) . map (| x | x . get ()) . unwrap_or_default () . get ()) as f64)) as sp :: Coord)) as _ }
                ) ;
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             ...
             let (h , w , x , y) = match index {
                 ...
                 + {
                     * & InnerStepItem_root_1 :: FIELD_OFFSETS . r#root_1_empty_2_layoutinfo_v }
                ) . apply_pin (_self) . get ())))) . r#preferred as sp :: Coord , (_self . parent . upgrade () . as_ref () . map (| x | (InnerAppWindow :: FIELD_OFFSETS . r#root_64_empty_74_visible_width) . apply_pin (x . as_pin_ref ()))) . map (| x | x . get ()) . unwrap_or_default () . get () as sp :: Coord , 0f64 as sp :: Coord , ({
                     * & InnerComponent_stepitem_77 :: FIELD_OFFSETS . r#stepitem_77_actual_y }
     ...
     impl InnerComponent_stepitem_77 {
         ...
         fn item_tree () -> & 'static [sp :: ItemTreeNode] {
             ...
             & ITEM_TREE }
         fn item_array () -> & 'static [sp :: VOffset < Self , sp :: ItemVTable , sp :: AllowPin >] {
             static ITEM_ARRAY : sp :: OnceBox < [sp :: VOffset < InnerComponent_stepitem_77 , sp :: ItemVTable , sp :: AllowPin > ;
     ...
     const _ : () = {
         use slint :: private_unstable_api :: re_exports :: * ;
         ItemTreeVTable_static ! (static VT for self :: InnerComponent_stepitem_77) ;
         }
     ;
     impl sp :: PinnedDrop for InnerComponent_stepitem_77 {
         fn drop (self : :: core :: pin :: Pin < & mut InnerComponent_stepitem_77 >) {
             sp :: vtable :: new_vref ! (let vref : VRef < sp :: ItemTreeVTable > for sp :: ItemTree = self . as_ref () . get_ref ()) ;
             if let Some (wa) = self . globals . get () . unwrap () . maybe_window_adapter_impl () {
                 sp :: unregister_item_tree (self . as_ref () , vref , Self :: item_array () , & wa) ;
                 }
     ...
     impl sp :: ItemTree for InnerComponent_stepitem_77 {
         fn visit_children_item (self : :: core :: pin :: Pin < & Self > , index : isize , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ >) -> sp :: VisitChildrenResult {
             return sp :: visit_item_tree (self , & sp :: VRcMapped :: origin (& self . as_ref () . self_weak . get () . unwrap () . upgrade () . unwrap ()) , self . get_item_tree () . as_slice () , index , order , visitor , visit_dynamic) ;
             # [allow (unused)] fn visit_dynamic (_self : :: core :: pin :: Pin < & InnerComponent_stepitem_77 > , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut < '_ > , dyn_index : u32) -> sp :: VisitChildrenResult {
                 _self . visit_dynamic_children (dyn_index , order , visitor) }
             }
         fn get_item_ref (self : :: core :: pin :: Pin < & Self > , index : u32) -> :: core :: pin :: Pin < sp :: ItemRef < '_ >> {
             match & self . get_item_tree () . as_slice () [index as usize] {
     ...
     impl sp :: RepeatedItemTree for InnerComponent_stepitem_77 {
         ...
         fn init (& self) {
             let self_rc = self . self_weak . get () . unwrap () . upgrade () . unwrap () ;
             InnerComponent_stepitem_77 :: user_init (sp :: VRcMapped :: map (self_rc , | x | x) ,) ;
             }
         fn listview_layout (self : :: core :: pin :: Pin < & Self > , offset_y : & mut sp :: LogicalLength ,) -> sp :: LogicalLength {
             let _self = self ;
             ({
     ...
     impl InnerAppWindow {
         ...
         fn item_array () -> & 'static [sp :: VOffset < Self , sp :: ItemVTable , sp :: AllowPin >] {
             ...
             & * ITEM_ARRAY . get_or_init (|| sp :: vec ! [sp :: VOffset :: new ({
                 ...
                 * & InnerAppWindow :: FIELD_OFFSETS . r#empty_70 }
            ) , sp :: VOffset :: new ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#rectangle_71 }
            ) , sp :: VOffset :: new ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#rectangle_93 }
                 ...
                 * & InnerAppWindow :: FIELD_OFFSETS . r#flickable_viewport_76 }
            ) , sp :: VOffset :: new ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#vertical_bar_80 }
            ) , sp :: VOffset :: new ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#vertical_bar_clip_81 }
                 ...
                 * & InnerAppWindow :: FIELD_OFFSETS . r#_visibility_112 }
                 ...
                 InnerAppWindow :: FIELD_OFFSETS . r#diskcontent_99 }
             + {
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#root_13 }
            ) , sp :: VOffset :: new ({
                 InnerAppWindow :: FIELD_OFFSETS . r#diskcontent_99 }
             + {
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#text_14 }
             ...
             + {
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#horizontal_bar_visibility_30 }
                 ...
                 InnerAppWindow :: FIELD_OFFSETS . r#diskcontent_99 }
             + {
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#flickable_viewport_20 }
            ) , sp :: VOffset :: new ({
                 InnerAppWindow :: FIELD_OFFSETS . r#diskcontent_99 }
             + {
                 * & InnerDiskContent_root_13 :: FIELD_OFFSETS . r#vertical_bar_24 }
     ...
     impl r#AppWindow {
         ...
         # [allow (dead_code)] pub fn get_disk_items (& self) -> sp :: ModelRc < r#DiskItem > {
             # [allow (unused_imports)] let _self = sp :: VRc :: as_pin_ref (& self . 0) ;
             ({
                 InnerAppWindow :: FIELD_OFFSETS . r#diskcontent_99 }
             + {
         ...
         # [allow (dead_code)] pub fn set_disk_items (& self , value : sp :: ModelRc < r#DiskItem >) {
             # [allow (unused_imports)] let _self = sp :: VRc :: as_pin_ref (& self . 0) ;
             ({
                 InnerAppWindow :: FIELD_OFFSETS . r#diskcontent_99 }
             + {
         ...
         # [allow (dead_code)] pub fn invoke_select_disk (& self , arg_0 : i32 ,) -> () {
             let _self = sp :: VRc :: as_pin_ref (& self . 0) ;
             ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_select_disk }
            ) . apply_pin (_self) . call (& (arg_0 ,)) }
         # [allow (dead_code)] pub fn on_select_disk (& self , mut f : impl FnMut (i32) -> () + 'static) {
             let _self = sp :: VRc :: as_pin_ref (& self . 0) ;
             # [allow (unused)] ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_64_select_disk }
 ...
 # [allow (unused_imports)] pub use slint_generatedAppWindow :: {
     r#AppWindow , r#DiskItem , r#StepData , }
 ;
